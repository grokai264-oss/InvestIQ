...
def score_symbol(symbol: str, timeframe: str = "daily") -> Dict[str, Any]:
    ...
    try:
        ...
        key_map = {
            "rsi": "score_rsi", "ema": "score_ema", "rvol": "score_rvol",
            "macd": "score_macd", "vwap": "score_vwap", "momentum": "score_momentum",
            "low_vol": "score_low_vol", "value": "score_value",
            "delivery": "score_rvol", "fii": "score_value",
        }
        ...
        return {
            ...
            "final_score": 50.0,
            "factors": {
                "score_rsi": 50.0, "score_ema": 50.0, "score_rvol": 40.0,
                "score_macd": 50.0, "score_vwap": 50.0, "score_momentum": 50.0,
                "score_low_vol": 50.0, "score_value": 50.0,
            },
            "weights": weights,
            "contributions": {},
